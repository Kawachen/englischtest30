...
public class EditQuestionBean {
    ...
    public void saveQuestion() {
        ...
        if(this.areAllRequiredInformationsGiven(possibleAnswerList, correctAnswerList)) {
            ...
            this.editQuestionError = EditQuestionError.REQUIRED_INFORMATION_MISSING;
        }
    }
    ...
    private boolean areAllRequiredInformationsGiven(ArrayList<String> possibleAnswers, ArrayList<Integer> correctAnswers) {
        if(this.questionPhrase == null || this.questionPhrase == "") {
            return false;
        }

        if(this.grammarSection == null || this.grammarSection == "") {
            return false;
        }
